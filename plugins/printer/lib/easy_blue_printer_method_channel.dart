...
class MethodChannelEasyBluePrinter extends EasyBluePrinterPlatform {
  ...
  @visibleForTesting
  final statusEventChannel = const EventChannel('easy_blue_printer_status');

  @override
  Stream<String> get connectionStatusStream => statusEventChannel.receiveBroadcastStream().map((event) => event as String);
