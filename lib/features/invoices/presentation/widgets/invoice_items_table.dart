  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: DataTable(
        ...
        columns: [
          DataColumn(
            label: Text(AppStrings.product, style: AppTypography.label),
          ),
          DataColumn(
            label: Text(AppStrings.qty, style: AppTypography.label),
            numeric: true,
          ),
          DataColumn(
            label: Text(AppStrings.total, style: AppTypography.label),
            numeric: true,
          ),
        ],
        rows: items.map((item) {
